...
//		timeZones();
    ...
    private static void playingWithTimeZones() {
        //ZoneId.getAvailableZoneIds().forEach(System.out::println);

        ZoneId parisZone = ZoneId.of("Europe/Paris");
        //parisZone.getRules().getTransitions().forEach(System.out::println);

        ZoneOffsetTransition offsetTransition = parisZone.getRules().nextTransition(Instant.now());
        System.out.println(offsetTransition);
